...
Route::get('/admin/user/', [AdminController::class, 'getUserAdmin'])->name('admin.user')->middleware(Admin::class);
...
Route::get('/admin/game/', [AdminController::class, 'getGameAdmin'])->name('admin.game')->middleware(Admin::class);
